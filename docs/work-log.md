...
| 15 | 2026-06-12 | [회의 시작 용어집 묶음 선택](work-log/2026-06-12-15-glossary-set-selection.md) | 회의 시작/파일 임포트 용어집을 분류 선택 + 직접 입력 방식으로 개편 |
| 16 | 2026-06-12 | [용어집 묶음 선택 리뷰 반영](work-log/2026-06-12-16-glossary-set-selection-review-fixes.md) | 선택 UI disabled-only 분류 제외, defaults 주입, 선택 영속 helper 공유 |
