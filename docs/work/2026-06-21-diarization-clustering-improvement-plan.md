...
| ③ | **LS-EEND vs VBx 측정** | M | **다음 작업** — FluidAudio LS-EEND(neural count, ≤10명, 클러스터링 없음)를 한국어 코퍼스에서 VBx와 비교. 설계: `2026-06-21-lseend-vs-vbx-count-measurement.md` |
...
- **③ LS-EEND 측정이 다음 결정 포인트**: EEND가 VBx보다 자동 count를 잘 맞추면, provider 디커플링과 함께 EEND 경로 도입을 ADR로 검토. 못 이기면 VBx+exactSpeakerCount 체제 확정.
