...
- Local LLM:
  ...
  - `deepseek-r1:8b`는 context correction과 summary JSON은 통과했지만 full-case grounded answer recall이 `0.333`이고 latency가 높다. 기본값 후보 결정은 추가 모델 또는 prompt 조정 benchmark 후 진행한다.
